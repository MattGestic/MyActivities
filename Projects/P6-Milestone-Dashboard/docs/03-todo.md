...
---
**Next code task (single line, always current):** TD-03 — locate and commit the three tokenization companion docs, which unblocks FEAT-14. If they cannot be found, TEST-02 (TD-04) is the next task instead.
